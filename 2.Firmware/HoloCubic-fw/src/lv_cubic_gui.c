...
void lv_holo_cubic_gui(void)
{
	...
	lv_style_set_bg_color(&default_style, LV_STATE_DEFAULT, LV_COLOR_BLACK);/*默认背景颜色：黑色*/
	lv_style_set_bg_color(&default_style, LV_STATE_PRESSED, LV_COLOR_GRAY);/*按下背景颜色：绿色*/
